...
# param_grid = {'n_neighbors': [4, 3, 1, 7, 10], 'metric': ['cosine', 'euclidean']}  # Add more metrics if needed
#
# # Custom scoring function
# def custom_scorer(estimator, X, y=None):
#     distances, indices = estimator.kneighbors(X)
#     mean_cosine_similarity = cosine_similarity(X, tfidf_matrix[indices]).mean()
#     return mean_cosine_similarity
#
# # Create GridSearchCV object
# grid_search = GridSearchCV(nn_model, param_grid, cv=5, scoring=make_scorer(custom_scorer))
#
# # Fit the model
